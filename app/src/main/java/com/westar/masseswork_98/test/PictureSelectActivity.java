...
/**
 * Created by ZWP on 2019/3/30 13:50.
 * 描述：图片选择界面
 */
public class PictureSelectActivity extends AppCompatActivity {
    ...
    PictureImageGridAdapter imageGridAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        config.imageSpanCount = 5;
        imageGridAdapter = new PictureImageGridAdapter(this,config);

        rySelect.setLayoutManager(new GridLayoutManager(this,5));
        rySelect.setAdapter(imageGridAdapter);


    }


//    public class SelecterPictureAdapter extends SingleBaseAdapter<LocalMedia>{
//
//        /**
//         * 带默认空布局显示的
//         *
...
//         * @param data
//         */
//        public SelecterPictureAdapter(Context context, @Nullable List<LocalMedia> data) {
//            super(context, data);
//        }
//
//        @Override
