...
/**
 * Created by ZWP on 2019/5/15 17:04.
 * 描述：
 */
public class CustomHorizonTabLayout extends HorizontalScrollView {
    private static final String TAG = "CustomHorizonTabLayout";
    ...
    //子view的背景图
    private int childViewBackgroundRes = -1;
    int[] textPadding;
    int[] textMargin;
    ...
    public CustomHorizonTabLayout setTextPadding(int[] textPadding) {
    ...
    public CustomHorizonTabLayout setTextMargin(int[] textMargin) {
        this.textMargin = textMargin;
        return this;
    }

    public int getChildViewBackgroundRes() {
        return childViewBackgroundRes;
    }

    public CustomHorizonTabLayout setChildViewBackgroundRes(int childViewBackgroundRes) {
        this.childViewBackgroundRes = childViewBackgroundRes;
        return this;
    }

    public CustomHorizonTabLayout(Context context) {
        this(context, null);
    }


    public CustomHorizonTabLayout(Context context, boolean hasIndicator) {
        this(context, null);
        mHasIndicator = hasIndicator;
    }

    public CustomHorizonTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, com.qmuiteam.qmui.R.attr.QMUITabSegmentStyle);
    }

    public CustomHorizonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CustomHorizonTabLayout addTab(Tab item) {
    ...
    public CustomHorizonTabLayout setTabTextSize(int tabTextSize) {
...
//        }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CustomHorizonTabLayout> mTabSegmentRef;

        public TabLayoutOnPageChangeListener(CustomHorizonTabLayout tabSegment) {
            mTabSegmentRef = new WeakReference<>(tabSegment);
        }

        @Override
        public void onPageScrollStateChanged(final int state) {
            final CustomHorizonTabLayout tabSegment = mTabSegmentRef.get();
            if (tabSegment != null) {
    ...
    public static class Tab {
        ...
        private TextView ensureSignCountView(Context context) {
            if (mSignCountTextView == null) {
                ...
                RelativeLayout.LayoutParams signCountLp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, QMUIResHelper.getAttrDimen(context, com.qmuiteam.qmui.R.attr.qmui_tab_sign_count_view_minSize));
    ...
    public class TabAdapter extends QMUIItemViewsAdapter<Tab, TabItemView> {
        ...
        @Override
        public List<TabItemView> getViews() {
