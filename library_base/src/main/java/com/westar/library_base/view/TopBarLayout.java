...
public class TopBarLayout extends LinearLayout {
    ...
    public TopBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean hasSeparator = array.getBoolean(R.styleable.QMUITopBar_qmui_topbar_need_separator, false);
//        statueBarHight = QMUIStatusBarHelper.getStatusbarHeight(context);
